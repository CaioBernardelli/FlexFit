...
public class Util {
	...
	public static ObjectContainer conectarBanco(){
		...
		config.common().objectClass(Personal.class).cascadeOnDelete(false);;
		config.common().objectClass(Personal.class).cascadeOnUpdate(true);;
		config.common().objectClass(Personal.class).cascadeOnActivate(true);
